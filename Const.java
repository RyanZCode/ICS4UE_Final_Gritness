...
public class Const {
    ...
    public static final ImageIcon PROFILE_ICON = new ImageIcon("images/person.png");
    public static final ImageIcon HISTORY_ICON = new ImageIcon("images/clock.png");
    public static final ImageIcon WORKOUT_ICON = new ImageIcon("images/barbell.png");
    public static final ImageIcon FOOD_ICON = new ImageIcon("images/food.png");
    public static final ImageIcon SOCIAL_ICON = new ImageIcon("images/social.png");
